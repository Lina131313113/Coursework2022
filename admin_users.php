...
<section class="users">
   ...
   <div class="box-container">
      ...
      ?>
      <div class="box">
         <p> идентификатор: <span><?php echo $fetch_users['id']; ?></span> </p>
         <p> имя пользователя: <span><?php echo $fetch_users['name']; ?></span> </p>
         <p> email: <span><?php echo $fetch_users['email']; ?></span> </p>
         <p> тип пользователя: <span style="color:<?php if($fetch_users['user_type'] == 'admin'){ echo 'var(--purple)'; } ?>"><?php echo $fetch_users['user_type']; ?></span> </p>
