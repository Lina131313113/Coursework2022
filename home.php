...
<section class="home">
   ...
   <div class="content">
      <h3>Надежный учет</h3>
      <p>К нам обращаются люди с разных городов.
Благодаря междкнародному знанию экономическим
систем, мы можем предоставить уникальные услуги.</p>
      <a href="about.php" class="white-btn">Узнайте больше</a>
   </div>
...
<section class="products">
   ...
   <h1 class="title">новейшие услуги</h1>
...
<section class="about">
   ...
   <div class="flex">
      ...
      <div class="content">
         <h3>О нас</h3>
         <p>Профессиональная бухгалтерская
команда с международным опытом.</p>
